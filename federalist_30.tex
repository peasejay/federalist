...
The more intelligent adversaries of the new Constitution admit the force of this reasoning; but they qualify their admission by a distinction between what they call \textsc{internal} and \textsc{external} taxation. 
...
This distinction, however, would violate the maxim of good sense and sound policy, which dictates that every \textsc{power} ought to be in proportion to its \textsc{object}; and would still leave the general government in a kind of tutelage to the State governments, inconsistent with every idea of vigor or efficiency. 
...
I believe it may be regarded as a position warranted by the history of mankind, that, \textsc{in the usual progress of things}, \textsc{the necessities of a nation}, \textsc{in every stage of its existence}, \textsc{will be found at least equal to its resources}.
...
Let us attend to what would be the effects of this situation in the very first war in which we should happen to be engaged. 
