...
The plausibility of this objection will vanish the moment we advert to the essential difference between a mere NON-\textsc{compliance} and a \textsc{direct} and \textsc{active resistance}. 
If the interposition of the State legislatures be necessary to give effect to a measure of the Union, they have only \textsc{not to act}, or \textsc{to act evasively}, and the measure is defeated. 
