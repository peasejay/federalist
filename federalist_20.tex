...
The true patriots have long bewailed the fatal tendency of these vices, and have made no less than four regular experiments by \textsc{extraordinary assemblies}, convened for the special purpose, to apply a remedy. 
As many times has their laudable zeal found it impossible to \textsc{unite the public councils} in reforming the known, the acknowledged, the fatal evils of the existing constitution. 
...
A design was also conceived of establishing a general tax to be administered by the federal authority. 
