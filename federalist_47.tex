...
From these facts, by which Montesquieu was guided, it may clearly be inferred that, in saying ``There can be no liberty where the legislative and executive powers are united in the same person, or body of magistrates," or, ``if the power of judging be not separated from the legislative and executive powers," he did not mean that these departments ought to have no \textsc{partial agency} in, or no \textsc{control} over, the acts of each other. 
His meaning, as his own words import, and still more conclusively as illustrated by the example in his eye, can amount to no more than this, that where the \textsc{whole} power of one department is exercised by the same hands which possess the \textsc{whole} power of another department, the fundamental principles of a free constitution are subverted. 
