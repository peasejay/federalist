...
I might find a witness in every citizen who has shared in, or been attentive to, the course of public administrations. 
...
The first example is that of Virginia, a State which, as we have seen, has expressly declared in its constitution, that the three great departments ought not to be intermixed. 
The authority in support of it is Mr. 
...
An \textsc{elective despotism} was not the government we fought for; but one which should not only be founded on free principles, but in which the powers of government should be so divided and balanced among several bodies of magistracy, as that no one could transcend their legal limits, without being effectually checked and restrained by the others. 
...
\textsc{but no barrier was provided between these several powers}. 
...
They have accordingly, \textsc{in many} instances, \textsc{decided rights} which should have been left to \textsc{judiciary controversy}, and \textsc{the direction of the executive}, \textsc{during the whole time of their session}, \textsc{is becoming habitual and familiar}."
