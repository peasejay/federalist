...
It relates neither to the execution of the subsisting laws, nor to the enaction of new ones; and still less to an exertion of the common strength. 
Its objects are \textsc{contracts} with foreign nations, which have the force of law, but derive it from the obligations of good faith. 
...
To require a fixed proportion of the whole body would not, in all probability, contribute to the advantages of a numerous agency, better then merely to require a proportion of the attending members. 
...
It ought not to be forgotten that, under the existing Confederation, two members may, and usually do, represent a State; whence it happens that Congress, who now are solely invested with all the powers of the Union, rarely consist of a greater number of persons than would compose the intended Senate. 
