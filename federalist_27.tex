...
Several additional reasons of considerable force, to fortify that probability, will occur when we come to survey, with a more critical eye, the interior structure of the edifice which we are invited to erect. 
...
It merits particular attention in this place, that the laws of the Confederacy, as to the \textsc{enumerated} and \textsc{legitimate} objects of its jurisdiction, will become the \textsc{supreme law} of the land; to the observance of which all officers, legislative, executive, and judicial, in each State, will be bound by the sanctity of an oath. 
