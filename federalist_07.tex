...
Divide et impera\footnote{Divide and command.} must be the motto of every nation that either hates or fears us.\footnote{In order that the whole subject of these papers may as soon as possible be laid before the public, it is proposed to publish them four times a week--on Tuesday in the New York Packet and on Thursday in the Daily Advertiser.}
